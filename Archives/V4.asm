COMMENT !
	Project Progress:
		...
		View Student Record Details - In Progress
		Log Out - Done
!
...
.data
	...
	studentGPAs REAL4 3.5, 3.6, 3.7, 3.8, 3.9, 4.0, 3.9, 3.8,
					  3.8, 3.7, 3.6, 3.9, 4.0, 3.7, 3.6, 3.8,
					  3.4, 3.5, 3.6, 3.7, 3.8, 3.5, 3.6, 3.7
				REAL4 128 DUP(?)   ; extra space for new students
